...
export default [
  ...
  },
  {
    ...
    children:[
      { path: 'category',meta:{icon: 'md-cube', title: '类目管理',access: ['system:user:list']}, name: 'product_category', component: () => import('@/view/product/category') },
      { path: 'info',meta:{icon: 'ios-basket',title: '商品列表',}, name: 'product_info', component: () => import('@/view/product/info') },
      { path: 'recommend',meta:{icon: 'ios-basket',title: '商品推荐',}, name: 'product_recommend', component: () => import('@/view/product/recommend') },
    ]
  },
  {
    path: '/401',
